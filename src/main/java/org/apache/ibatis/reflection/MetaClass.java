  ...
  private Class<?> getGetterType(PropertyTokenizer prop) {
    ...
    if (prop.getIndex() != null && Collection.class.isAssignableFrom(type)) {
      ...
      if (returnType instanceof ParameterizedType) {
        ...
        /**
         * getActualTypeArguments() Returns an array of objects representing the actual type arguments to this type.
         * List<String> 返回String, Class 类型 List<ArrayList<String>> 返回ArrayList<String>，ParameterizedType类型 List<?
         * extends Number> 返回? extends Number，WildcardType类型 ...
         */
